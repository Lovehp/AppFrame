 ...
 * 文件观察
 * @author luhf
 * @date 2013-6-11 下午5:59:40
 */
public class FileObserver extends FileAlterationObserver{

	private static final long serialVersionUID=4151129138867048907L;
	...
	/**
	 * 设置观查的文件路径,带文件过滤器，比如所有xml文件. 这里的IOCase是设置文件比较器(排序).[根据系统，可以不用理会]
	 * 
	 * @param directoryName
	 * @param fileFilter
	 */
	...
	/**
	 * 监控启动时初始化方法 1. 刷新本文件对象 2. 得到本文件列表 3. 循环初始化File实体 4. 设置本文件以及其下的上下级关系
	 */
	 ...
	 * 如果名称长度排在之后，添加文件，并调用onDirectoryCreate/onFileCreate 这样就注册了所有文件的监听器
	 */
